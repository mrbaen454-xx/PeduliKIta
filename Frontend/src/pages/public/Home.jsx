...
const Home = () => {
  ...
  // Featured Campaigns: Top 3
  const featuredCampaigns = campaigns.slice(0, 3);
  const listCampaigns = campaigns.slice(3, 9); // Display next up to 6
  ...
  return (
    <div className="bg-background min-h-screen text-on-surface font-sans selection:bg-primary-fixed selection:text-on-primary-fixed">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden py-12 px-6 md:px-10 lg:px-12 max-w-[1240px] mx-auto bg-[var(--color-surface-container)]/70 backdrop-blur-2xl border border-[var(--color-primary)]/20 shadow-[0_20px_50px_rgba(0,107,44,0.12)] rounded-3xl mb-12 mt-4">
        <div className="flex items-center gap-2 text-primary font-bold text-xs uppercase tracking-widest mb-6 border border-outline-variant rounded-full px-3 py-1.5 w-max bg-surface-container-lowest shadow-sm">
          <ShieldCheck className="w-4 h-4" />
          <span>Platform Validasi Tanpa Potongan</span>
        </div>
        
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="space-y-6">
            <h1 className="text-display-hero-mobile md:text-display-hero font-serif font-bold leading-tight text-on-surface">
      ...
      {/* Categories Section */}
      <section className="py-12 px-6 md:px-10 lg:px-12 max-w-[1240px] mx-auto bg-[var(--color-surface-container)]/70 backdrop-blur-2xl border border-[var(--color-primary)]/20 shadow-[0_20px_50px_rgba(0,107,44,0.12)] rounded-3xl mb-12">
      ...
      {/* How it Works */}
      <section className="py-16 px-6 md:px-10 lg:px-12 max-w-[1240px] mx-auto bg-[var(--color-surface-container)]/70 backdrop-blur-2xl border border-[var(--color-primary)]/20 shadow-[0_20px_50px_rgba(0,107,44,0.12)] rounded-3xl mb-12" id="cara-kerja">
      ...
      <section className="py-12 px-4 max-w-[1240px] mx-auto mb-12">
        <div className="max-w-[1000px] mx-auto bg-primary rounded-3xl p-12 md:p-16 text-center text-white relative overflow-hidden shadow-xl border border-primary-container">
          {/* Subtle bg pattern */}
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-5xl font-serif font-bold mb-6 leading-tight">
              Punya Kebaikan yang Ingin <br/> Kamu Mulai?
            </h2>
            <p className="text-lg md:text-xl text-primary-fixed mb-10 max-w-2xl mx-auto font-medium leading-relaxed">
            ...
            <div className="mt-8 flex justify-center gap-8 text-xs font-bold text-primary-fixed uppercase tracking-wider">
